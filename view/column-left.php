    ...
    <div class="column-left">
        ...
        <div class="option-div-container margin-top">
            ...
            <div class="option-div-list">
                <form action="">
                    <input type="radio" id="view-max" name="sort-by" value="view-max" checked>
                    <label for="view-max">Views: most popular</label>
                    <div class="clearfix"></div>
                    <input type="radio" id="view-min" name="sort-by" value="view-min">
                    <label for="view-min">Views: not interesting</label>
					<div class="clearfix"></div>
					<input type="radio" id="date-max" name="sort-by" value="date-max">
        ...
        <div class="option-div-container margin-top">
            ...
            <div class="option-div-list">
                <? foreach ($products as $product) {
                    $p = '<p data-name="' . $product['href'] . '"><a href="' . $product['href'] . '">' . $product['name'] . '</a></p>';
                    echo $p;
                }?>
            </div>
        </div>
